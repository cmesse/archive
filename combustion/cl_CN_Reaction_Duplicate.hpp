...
#ifndef BELFEM_CL_CN_REACTION_DUPLICATE_HPP
#define BELFEM_CL_CN_REACTION_DUPLICATE_HPP
...
//------------------------------------------------------------------------------
        ...
        class Reaction_Duplicate : public Reaction
        {
...
//------------------------------------------------------------------------------
            ...
            Reaction_Duplicate(              Scheme & aScheme,
...
#endif //BELFEM_CL_CN_REACTION_DUPLICATE_HPP
